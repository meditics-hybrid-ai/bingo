...
- Use Android adaptive launcher icons with a logo-matched background to avoid white padding.
...
- Add Android adaptive launcher icon foreground/background assets. Done.
